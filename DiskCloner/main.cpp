...
)
{
  ...
  HICON ico;
  ico = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDISKFLASH));
  SendMessage(dialog, WM_SETICON, ICON_SMALL, (LPARAM)ico);
  SendMessage(dialog, WM_SETICON, ICON_BIG, (LPARAM)ico);
